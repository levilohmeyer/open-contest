    ...
    return Page(
        ...
        Card("Problem Details", div(cls="problem-details", contents=[
            h.form(cls="row", contents=[
                ...
                div(cls="form-group col-12", contents=[
                    h.label(**{"for": "problem-timeLimit", "contents":"Time Limit (seconds)"}),
                    h.input(cls="form-control", type="number", name="problem-timeLimit", id="problem-timeLimit", value=prob.timeLimit)
                ]),
                div(cls="form-group col-12", contents=[
